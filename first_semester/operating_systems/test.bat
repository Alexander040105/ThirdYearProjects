...
if not exist "%sourceFolder%\Music" mkdir "%sourceFolder%\Apps"
if not exist "%sourceFolder%\Music" mkdir "%sourceFolder%\ArtFiles"
if not exist "%sourceFolder%\Music" mkdir "%sourceFolder%\Zips"
...
rem Display the summary
echo Sorting completed. Summary:
echo.
echo Number of .txt/.docx/ .pdf/.pptx files moved:    %docCount%
...
echo Number of .ai/.psd files moved:    %pntCount%
echo Number of .rar/.zip files moved:    %ZipCount%
